...
# relative imports
import sys
sys.path.append("../../vectorized_cls_metrics")
...
if __name__ == '__main__':
    ...
    #print(args.log, args.logLevel)
    #Namespace(labels = None, log = None, logLevel = 'INFO',
    # outputDir = '../results', predictions = '../data/prediction/test', reference = '.....)
